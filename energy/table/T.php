                         ...
                         <tbody>
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT energy FROM T ORDER BY id DESC LIMIT 1 OFFSET 0");
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT MAX(energy) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                                                  echo $d['MAX(energy)'];
                                                  }
                                             ?>
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT MIN(energy) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                                                  echo $d['MIN(energy)'];
                                                  }
                                             ?>
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT AVG(energy) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                                                  echo $d['AVG(energy)'];
                                                  }
                                             ?>
