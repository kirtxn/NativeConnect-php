                         ...
                         <tbody>
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT voltage FROM T ORDER BY id DESC LIMIT 1 OFFSET 0");
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT MAX(voltage) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                                                  echo $d['MAX(voltage)'];
                                                  }
                                             ?>
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT MIN(voltage) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                                                  echo $d['MIN(voltage)'];
                                                  }
                                             ?>
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT AVG(voltage) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                                                  echo $d['AVG(voltage)'];
                                                  }
                                             ?>
