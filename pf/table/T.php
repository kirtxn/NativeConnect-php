                         ...
                         <tbody>
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT pf FROM T ORDER BY id DESC LIMIT 1 OFFSET 0");
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT MAX(pf) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                                                  echo $d['MAX(pf)'];
                                                  }
                                             ?>
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT MIN(pf) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                                                  echo $d['MIN(pf)'];
                                                  }
                                             ?>
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT AVG(pf) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                                                  echo $d['AVG(pf)'];
                                                  }
                                             ?>
