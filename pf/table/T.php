                         ...
                         <tbody>
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT frequency FROM T ORDER BY id DESC LIMIT 1 OFFSET 0");
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT MAX(frequency) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT MIN(frequency) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
                              ...
                              <tr>
                                   ...
                                   <td>
                                        <p class="text-sm font-weight-bold mb-0">
                                             <?php
                                                  $value = mysqli_query($connect,"SELECT AVG(frequency) FROM T");
                                                       while($d=mysqli_fetch_array($value)){
